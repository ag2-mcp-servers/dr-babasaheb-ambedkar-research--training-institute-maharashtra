...
#   timestamp: 2025-06-28T14:53:16+00:00
...
class CertificateParameters(BaseModel):
    ...
    VCNo: str = Field(..., description='VC No', examples=['XXXX-XXXXXXXXX'])
...
class CvcerCertificatePostRequest(BaseModel):
...
class CvcerCertificatePostResponse(BaseModel):
...
class CvcerCertificatePostResponse1(BaseModel):
...
class CvcerCertificatePostResponse2(BaseModel):
...
class CvcerCertificatePostResponse3(BaseModel):
...
class CvcerCertificatePostResponse4(BaseModel):
...
class CvcerCertificatePostResponse5(BaseModel):
...
class CvcerCertificatePostResponse6(BaseModel):
